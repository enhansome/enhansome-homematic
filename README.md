...
* [OpenCCU Wiki](https://github.com/OpenCCU/OpenCCU/wiki) ⭐ 1,826 | 🐛 186 | 🌐 JavaScript | 📅 2026-09-11 - Installation, Administration und Nutzung von OpenCCU.
...
* [OpenCCU](https://github.com/OpenCCU/OpenCCU) ⭐ 1,826 | 🐛 186 | 🌐 JavaScript | 📅 2026-09-11 - Lightweight, OCCU and Linux/buildroot-based distribution for running a HomeMatic CCU on embedded devices like the RaspberryPi, x86/ARM or as virtual appliance (formerly known as RaspberryMatic).
...
* [RedMatic](https://github.com/rdmtc/RedMatic) ⭐ 529 | 🐛 3 | 🌐 Shell | 📅 2026-09-11 - [Node-RED](https://nodered.org/) als Addon für die Homematic CCU3 und OpenCCU. Liefert u.A. komfortable HomeKit-Integration und spezielle Nodes zur Anbindung der CCU an MQTT mit.
...
* [homematicip\_local](https://github.com/SukramJ/homematicip_local) ⭐ 593 | 🐛 0 | 🌐 Python | 📅 2026-09-11 - [Home Assistant](https://www.home-assistant.io/) Custom Component zur lokalen Anbindung von CCU/OpenCCU (Homematic und Homematic IP), basiert auf aiohomematic.
...
* [homematicip-hcu](https://github.com/Ediminator/homematicip-hcu) ⭐ 73 | 🐛 7 | 🌐 Python | 📅 2026-09-11 - [Home Assistant](https://www.home-assistant.io/) Integration zur lokalen Anbindung der Homematic IP Home Control Unit (HCU) ohne Cloud.
* [node-red-contrib-ccu](https://github.com/rdmtc/node-red-contrib-ccu) ⭐ 69 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-09 - [Node-RED](https://nodered.org) Nodes for the Homematic CCU.
...
* [hm2mqtt.js](https://github.com/hobbyquaker/hm2mqtt.js) ⭐ 22 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-10 - Node.js based interface between Homematic and MQTT.
...
* [OpenCCU-Loom](https://github.com/SukramJ/openccu-loom) ⭐ 5 | 🐛 0 | 🌐 Go | 📅 2026-09-11 - Standalone Go daemon bridging Homematic / Homematic IP CCUs to MQTT (with Home Assistant Discovery), REST + WebSocket, an MCP server and a native Matter bridge.
* [matterbridge-homematic](https://github.com/hobbyquaker/matterbridge-homematic) ⭐ 4 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-16 - [Matterbridge](https://github.com/Luligu/matterbridge) ⭐ 971 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-11 Plugin to bridge a Homematic CCU's devices to the Matter ecosystem.
...
* [homematic-manager](https://github.com/hobbyquaker/homematic-manager) ⭐ 196 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-10 - Manage homematic interface processes (rfd/hs485d/homegear).
* [HMDeviceFirmware](https://github.com/OpenCCU/HMDeviceFirmware) ⭐ 34 | 🐛 0 | 🌐 Shell | 📅 2026-09-11 - Archive of current and past firmware update files for HomeMatic and Homematic IP devices.
...
* [aiohomematic](https://github.com/SukramJ/aiohomematic) ⭐ 167 | 🐛 1 | 🌐 Python | 📅 2026-09-11 - Python 3 interface to interact with Homematic devices via XML-RPC and JSON-RPC, successor of [pyhomematic](https://github.com/danielperna84/pyhomematic) ⚠️ Archived and base of homematicip\_local.
...
* [Home Assistant](https://www.home-assistant.io/) - via [homematicip\_local](https://github.com/SukramJ/homematicip_local) ⭐ 593 | 🐛 0 | 🌐 Python | 📅 2026-09-11 (CCU/OpenCCU) oder [homematicip-hcu](https://github.com/Ediminator/homematicip-hcu) ⭐ 73 | 🐛 7 | 🌐 Python | 📅 2026-09-11 (HCU).
...
* [SmartHomeNG](https://www.smarthomeng.de/) - via [Plugins](https://github.com/smarthomeNG/plugins) ⭐ 44 | 🐛 9 | 🌐 Python | 📅 2026-09-09.
