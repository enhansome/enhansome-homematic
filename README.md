...
* [OpenCCU Wiki](https://github.com/OpenCCU/OpenCCU/wiki) ⭐ 1,831 | 🐛 189 | 🌐 JavaScript | 📅 2026-09-18 - Installation, Administration und Nutzung von OpenCCU.
...
* [OpenCCU](https://github.com/OpenCCU/OpenCCU) ⭐ 1,831 | 🐛 189 | 🌐 JavaScript | 📅 2026-09-18 - Lightweight, OCCU and Linux/buildroot-based distribution for running a HomeMatic CCU on embedded devices like the RaspberryPi, x86/ARM or as virtual appliance (formerly known as RaspberryMatic).
...
* [homebridge-homematic](https://github.com/thkl/homebridge-homematic) ⚠️ Archived - [Homebridge](https://github.com/nfarina/homebridge) ⭐ 25,495 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-30 Plugin zur Einbindung von Homematic Geräten in HomeKit.
* [CCU-Jack](https://github.com/mdzio/ccu-jack) ⭐ 147 | 🐛 32 | 🌐 Go | 📅 2026-08-30 - CCU-Jack bietet einen einfachen und sicheren REST-basierten Zugriff auf die CCU, auch als Addon verfügbar.
* [homebridge-homematicip](https://github.com/marcsowen/homebridge-homematicip) ⭐ 85 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-14 - [Homebridge](https://github.com/nfarina/homebridge) ⭐ 25,495 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-30 Plugin zur Einbindung von Homematic IP mit HmIP-HAP via Cloud.
* [homematicip-hcu](https://github.com/Ediminator/homematicip-hcu) ⭐ 73 | 🐛 7 | 🌐 Python | 📅 2026-09-18 - [Home Assistant](https://www.home-assistant.io/) Integration zur lokalen Anbindung der Homematic IP Home Control Unit (HCU) ohne Cloud.
...
* [matterbridge-homematic](https://github.com/hobbyquaker/matterbridge-homematic) ⭐ 4 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-16 - [Matterbridge](https://github.com/Luligu/matterbridge) ⭐ 973 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-18 Plugin to bridge a Homematic CCU's devices to the Matter ecosystem.
...
* [homematic-manager](https://github.com/hobbyquaker/homematic-manager) ⭐ 196 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-18 - Manage homematic interface processes (rfd/hs485d/homegear).
* [HMDeviceFirmware](https://github.com/OpenCCU/HMDeviceFirmware) ⭐ 34 | 🐛 0 | 🌐 Shell | 📅 2026-09-18 - Archive of current and past firmware update files for HomeMatic and Homematic IP devices.
...
* [Home Assistant](https://www.home-assistant.io/) - via [homematicip\_local](https://github.com/SukramJ/homematicip_local) ⭐ 594 | 🐛 0 | 🌐 Python | 📅 2026-09-12 (CCU/OpenCCU) oder [homematicip-hcu](https://github.com/Ediminator/homematicip-hcu) ⭐ 73 | 🐛 7 | 🌐 Python | 📅 2026-09-18 (HCU).
* [ioBroker](https://www.iobroker.net/?lang=de) - via [hm-rpc](https://github.com/ioBroker/ioBroker.hm-rpc) ⭐ 62 | 🐛 90 | 🌐 HTML | 📅 2026-09-18 (Interface-Prozesse) und [hm-rega](https://github.com/ioBroker/ioBroker.hm-rega) ⭐ 43 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-18 (ReGaHSS) Adapter, [hmip](https://github.com/iobroker-community-adapters/ioBroker.hmip) ⭐ 31 | 🐛 37 | 🌐 JavaScript | 📅 2026-09-11 für den Homematic IP Cloud Access Point.
