...
* [RaspberryMatic](https://github.com/jens-maus/RaspberryMatic) ⭐ 1,821 | 🐛 187 | 🌐 JavaScript | 📅 2026-08-15 - Lightweight, OCCU and Linux/buildroot-based distribution for running a HomeMatic CCU on embedded devices like the RaspberryPi.
...
* [hm\_pdetect](https://github.com/jens-maus/hm_pdetect) ⭐ 72 | 🐛 49 | 🌐 Tcl | 📅 2023-07-13 - Anwesenheitserkennung über die FRITZ!-Box
* [Homematic-addon-hue](https://github.com/j-a-n/homematic-addon-hue) ⚠️ Archived - HomeMatic Addon für Philips Hue.
* [Email](https://github.com/jens-maus/hm_email) ⭐ 46 | 🐛 15 | 🌐 HTML | 📅 2023-01-05 - HomeMatic CCU Addon für den Email Versand.
...
* [hm-tools](https://github.com/fhetty/hm-tools) ⭐ 25 | 🐛 5 | 🌐 C | 📅 2023-07-30 - Sammlung von Tools für RaspberryMatic.
...
* [hm-print](https://github.com/litti/hm-print) ⭐ 11 | 🐛 10 | 🌐 CSS | 📅 2022-12-13 - CCU Programme drucken.
...
* [homebridge-homematic](https://github.com/thkl/homebridge-homematic) ⚠️ Archived - [Homebridge](https://github.com/nfarina/homebridge) ⭐ 25,453 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-15 Plugin zur Einbindung von Homematic Geräten in HomeKit.
* [CCU-Jack](https://github.com/mdzio/ccu-jack) ⭐ 146 | 🐛 44 | 🌐 Go | 📅 2026-07-10 - CCU-Jack bietet einen einfachen und sicheren REST-basierten Zugriff auf die CCU, auch als Addon verfügbar.
* [homebridge-homematicip](https://github.com/marcsowen/homebridge-homematicip) ⭐ 85 | 🐛 79 | 🌐 TypeScript | 📅 2026-08-14 - [Homebridge](https://github.com/nfarina/homebridge) ⭐ 25,453 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-15 Plugin zur Einbindung von Homematic IP mit HmIP-HAP via Cloud.
