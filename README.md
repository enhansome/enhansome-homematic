...
* [OpenCCU Wiki](https://github.com/OpenCCU/OpenCCU/wiki) ⭐ 1,827 | 🐛 193 | 🌐 JavaScript | 📅 2026-09-06 - Installation, Administration und Nutzung von OpenCCU.
...
* [OpenCCU](https://github.com/OpenCCU/OpenCCU) ⭐ 1,827 | 🐛 193 | 🌐 JavaScript | 📅 2026-09-06 - Lightweight, OCCU and Linux/buildroot-based distribution for running a HomeMatic CCU on embedded devices like the RaspberryPi, x86/ARM or as virtual appliance (formerly known as RaspberryMatic).
...
* [HB-RF-ETH-ng](https://github.com/Xerolux/HB-RF-ETH-ng) ⭐ 14 | 🐛 1 | 🌐 C++ | 📅 2026-09-06 - Modernisierte Next-Generation-Firmware für die HB-RF-ETH Platine mit neuer Weboberfläche und MQTT-Monitoring.
...
* [Mosquitto](https://github.com/homematic-community/ccu-addon-mosquitto) ⭐ 34 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-05 - Mosquitto packaged as Addon for the Homematic CCU3 and OpenCCU
...
* [homematicip\_local](https://github.com/SukramJ/homematicip_local) ⭐ 591 | 🐛 0 | 🌐 Python | 📅 2026-09-06 - [Home Assistant](https://www.home-assistant.io/) Custom Component zur lokalen Anbindung von CCU/OpenCCU (Homematic und Homematic IP), basiert auf aiohomematic.
* [homebridge-homematic](https://github.com/thkl/homebridge-homematic) ⚠️ Archived - [Homebridge](https://github.com/nfarina/homebridge) ⭐ 25,476 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-30 Plugin zur Einbindung von Homematic Geräten in HomeKit.
...
* [homebridge-homematicip](https://github.com/marcsowen/homebridge-homematicip) ⭐ 86 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-28 - [Homebridge](https://github.com/nfarina/homebridge) ⭐ 25,476 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-30 Plugin zur Einbindung von Homematic IP mit HmIP-HAP via Cloud.
* [homematicip-hcu](https://github.com/Ediminator/homematicip-hcu) ⭐ 73 | 🐛 6 | 🌐 Python | 📅 2026-09-06 - [Home Assistant](https://www.home-assistant.io/) Integration zur lokalen Anbindung der Homematic IP Home Control Unit (HCU) ohne Cloud.
...
* [OpenCCU-Loom](https://github.com/SukramJ/openccu-loom) ⭐ 5 | 🐛 0 | 🌐 Go | 📅 2026-09-06 - Standalone Go daemon bridging Homematic / Homematic IP CCUs to MQTT (with Home Assistant Discovery), REST + WebSocket, an MCP server and a native Matter bridge.
* [matterbridge-homematic](https://github.com/hobbyquaker/matterbridge-homematic) ⭐ 4 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-16 - [Matterbridge](https://github.com/Luligu/matterbridge) ⭐ 966 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-06 Plugin to bridge a Homematic CCU's devices to the Matter ecosystem.
...
* [homematic-manager](https://github.com/hobbyquaker/homematic-manager) ⭐ 197 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-06 - Manage homematic interface processes (rfd/hs485d/homegear).
* [HMDeviceFirmware](https://github.com/OpenCCU/HMDeviceFirmware) ⭐ 33 | 🐛 0 | 🌐 Shell | 📅 2026-09-06 - Archive of current and past firmware update files for HomeMatic and Homematic IP devices.
...
* [aiohomematic](https://github.com/SukramJ/aiohomematic) ⭐ 167 | 🐛 0 | 🌐 Python | 📅 2026-09-06 - Python 3 interface to interact with Homematic devices via XML-RPC and JSON-RPC, successor of [pyhomematic](https://github.com/danielperna84/pyhomematic) ⚠️ Archived and base of homematicip\_local.
...
* [Home Assistant](https://www.home-assistant.io/) - via [homematicip\_local](https://github.com/SukramJ/homematicip_local) ⭐ 591 | 🐛 0 | 🌐 Python | 📅 2026-09-06 (CCU/OpenCCU) oder [homematicip-hcu](https://github.com/Ediminator/homematicip-hcu) ⭐ 73 | 🐛 6 | 🌐 Python | 📅 2026-09-06 (HCU).
* [ioBroker](https://www.iobroker.net/?lang=de) - via [hm-rpc](https://github.com/ioBroker/ioBroker.hm-rpc) ⭐ 61 | 🐛 81 | 🌐 HTML | 📅 2026-09-04 (Interface-Prozesse) und [hm-rega](https://github.com/ioBroker/ioBroker.hm-rega) ⭐ 43 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-31 (ReGaHSS) Adapter, [hmip](https://github.com/iobroker-community-adapters/ioBroker.hmip) ⭐ 31 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-05 für den Homematic IP Cloud Access Point.
* [SmartHomeNG](https://www.smarthomeng.de/) - via [Plugins](https://github.com/smarthomeNG/plugins) ⭐ 44 | 🐛 9 | 🌐 Python | 📅 2026-09-05.
