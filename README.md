...
* [OpenCCU Wiki](https://github.com/OpenCCU/OpenCCU/wiki) ⭐ 1,826 | 🐛 187 | 🌐 JavaScript | 📅 2026-09-12 - Installation, Administration und Nutzung von OpenCCU.
...
* [OpenCCU](https://github.com/OpenCCU/OpenCCU) ⭐ 1,826 | 🐛 187 | 🌐 JavaScript | 📅 2026-09-12 - Lightweight, OCCU and Linux/buildroot-based distribution for running a HomeMatic CCU on embedded devices like the RaspberryPi, x86/ARM or as virtual appliance (formerly known as RaspberryMatic).
...
* [HB-RF-ETH-ng](https://github.com/Xerolux/HB-RF-ETH-ng) ⭐ 14 | 🐛 2 | 🌐 C++ | 📅 2026-09-11 - Modernisierte Next-Generation-Firmware für die HB-RF-ETH Platine mit neuer Weboberfläche und MQTT-Monitoring.
...
* [RedMatic](https://github.com/rdmtc/RedMatic) ⭐ 529 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-12 - [Node-RED](https://nodered.org/) als Addon für die Homematic CCU3 und OpenCCU. Liefert u.A. komfortable HomeKit-Integration und spezielle Nodes zur Anbindung der CCU an MQTT mit.
...
* [homematicip\_local](https://github.com/SukramJ/homematicip_local) ⭐ 593 | 🐛 0 | 🌐 Python | 📅 2026-09-12 - [Home Assistant](https://www.home-assistant.io/) Custom Component zur lokalen Anbindung von CCU/OpenCCU (Homematic und Homematic IP), basiert auf aiohomematic.
* [homebridge-homematic](https://github.com/thkl/homebridge-homematic) ⚠️ Archived - [Homebridge](https://github.com/nfarina/homebridge) ⭐ 25,485 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-30 Plugin zur Einbindung von Homematic Geräten in HomeKit.
...
* [homebridge-homematicip](https://github.com/marcsowen/homebridge-homematicip) ⭐ 86 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-08 - [Homebridge](https://github.com/nfarina/homebridge) ⭐ 25,485 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-30 Plugin zur Einbindung von Homematic IP mit HmIP-HAP via Cloud.
* [homematicip-hcu](https://github.com/Ediminator/homematicip-hcu) ⭐ 73 | 🐛 7 | 🌐 Python | 📅 2026-09-12 - [Home Assistant](https://www.home-assistant.io/) Integration zur lokalen Anbindung der Homematic IP Home Control Unit (HCU) ohne Cloud.
* [node-red-contrib-ccu](https://github.com/rdmtc/node-red-contrib-ccu) ⭐ 69 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-12 - [Node-RED](https://nodered.org) Nodes for the Homematic CCU.
...
* [OpenCCU-Loom](https://github.com/SukramJ/openccu-loom) ⭐ 5 | 🐛 0 | 🌐 Go | 📅 2026-09-12 - Standalone Go daemon bridging Homematic / Homematic IP CCUs to MQTT (with Home Assistant Discovery), REST + WebSocket, an MCP server and a native Matter bridge.
* [matterbridge-homematic](https://github.com/hobbyquaker/matterbridge-homematic) ⭐ 4 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-16 - [Matterbridge](https://github.com/Luligu/matterbridge) ⭐ 972 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-12 Plugin to bridge a Homematic CCU's devices to the Matter ecosystem.
...
* [homematic-manager](https://github.com/hobbyquaker/homematic-manager) ⭐ 196 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-12 - Manage homematic interface processes (rfd/hs485d/homegear).
* [HMDeviceFirmware](https://github.com/OpenCCU/HMDeviceFirmware) ⭐ 34 | 🐛 0 | 🌐 Shell | 📅 2026-09-12 - Archive of current and past firmware update files for HomeMatic and Homematic IP devices.
...
* [aiohomematic](https://github.com/SukramJ/aiohomematic) ⭐ 167 | 🐛 0 | 🌐 Python | 📅 2026-09-12 - Python 3 interface to interact with Homematic devices via XML-RPC and JSON-RPC, successor of [pyhomematic](https://github.com/danielperna84/pyhomematic) ⚠️ Archived and base of homematicip\_local.
...
* [Home Assistant](https://www.home-assistant.io/) - via [homematicip\_local](https://github.com/SukramJ/homematicip_local) ⭐ 593 | 🐛 0 | 🌐 Python | 📅 2026-09-12 (CCU/OpenCCU) oder [homematicip-hcu](https://github.com/Ediminator/homematicip-hcu) ⭐ 73 | 🐛 7 | 🌐 Python | 📅 2026-09-12 (HCU).
* [ioBroker](https://www.iobroker.net/?lang=de) - via [hm-rpc](https://github.com/ioBroker/ioBroker.hm-rpc) ⭐ 61 | 🐛 86 | 🌐 HTML | 📅 2026-09-10 (Interface-Prozesse) und [hm-rega](https://github.com/ioBroker/ioBroker.hm-rega) ⭐ 43 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-11 (ReGaHSS) Adapter, [hmip](https://github.com/iobroker-community-adapters/ioBroker.hmip) ⭐ 31 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-11 für den Homematic IP Cloud Access Point.
* [SmartHomeNG](https://www.smarthomeng.de/) - via [Plugins](https://github.com/smarthomeNG/plugins) ⭐ 44 | 🐛 10 | 🌐 Python | 📅 2026-09-09.
