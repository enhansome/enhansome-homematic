...
* [OpenCCU Wiki](https://github.com/OpenCCU/OpenCCU/wiki) ⭐ 1,832 | 🐛 189 | 🌐 JavaScript | 📅 2026-09-19 - Installation, Administration und Nutzung von OpenCCU.
...
* [OpenCCU](https://github.com/OpenCCU/OpenCCU) ⭐ 1,832 | 🐛 189 | 🌐 JavaScript | 📅 2026-09-19 - Lightweight, OCCU and Linux/buildroot-based distribution for running a HomeMatic CCU on embedded devices like the RaspberryPi, x86/ARM or as virtual appliance (formerly known as RaspberryMatic).
...
* [HB-RF-ETH-ng](https://github.com/Xerolux/HB-RF-ETH-ng) ⭐ 14 | 🐛 4 | 🌐 C++ | 📅 2026-09-14 - Modernisierte Next-Generation-Firmware für die HB-RF-ETH Platine mit neuer Weboberfläche und MQTT-Monitoring.
...
* [RedMatic](https://github.com/rdmtc/RedMatic) ⭐ 529 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-17 - [Node-RED](https://nodered.org/) als Addon für die Homematic CCU3 und OpenCCU. Liefert u.A. komfortable HomeKit-Integration und spezielle Nodes zur Anbindung der CCU an MQTT mit.
...
* [JP-HB-Devices-addon](https://github.com/jp112sdl/JP-HB-Devices-addon) ⭐ 57 | 🐛 0 | 🌐 Tcl | 📅 2026-09-17 - Addon das über 80 Selbstbau-Geräte (AskSinPP HomeBrew) in die CCU/OpenCCU Firmware integriert.
...
* [Mosquitto](https://github.com/homematic-community/ccu-addon-mosquitto) ⭐ 34 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-06 - Mosquitto packaged as Addon for the Homematic CCU3 and OpenCCU
...
* [homematicip\_local](https://github.com/SukramJ/homematicip_local) ⭐ 594 | 🐛 0 | 🌐 Python | 📅 2026-09-12 - [Home Assistant](https://www.home-assistant.io/) Custom Component zur lokalen Anbindung von CCU/OpenCCU (Homematic und Homematic IP), basiert auf aiohomematic.
* [homebridge-homematic](https://github.com/thkl/homebridge-homematic) ⚠️ Archived - [Homebridge](https://github.com/nfarina/homebridge) ⭐ 25,494 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-30 Plugin zur Einbindung von Homematic Geräten in HomeKit.
* [CCU-Jack](https://github.com/mdzio/ccu-jack) ⭐ 148 | 🐛 32 | 🌐 Go | 📅 2026-08-30 - CCU-Jack bietet einen einfachen und sicheren REST-basierten Zugriff auf die CCU, auch als Addon verfügbar.
* [homebridge-homematicip](https://github.com/marcsowen/homebridge-homematicip) ⭐ 85 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-14 - [Homebridge](https://github.com/nfarina/homebridge) ⭐ 25,494 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-30 Plugin zur Einbindung von Homematic IP mit HmIP-HAP via Cloud.
* [homematicip-hcu](https://github.com/Ediminator/homematicip-hcu) ⭐ 73 | 🐛 7 | 🌐 Python | 📅 2026-09-19 - [Home Assistant](https://www.home-assistant.io/) Integration zur lokalen Anbindung der Homematic IP Home Control Unit (HCU) ohne Cloud.
...
* [hm2mqtt.js](https://github.com/hobbyquaker/hm2mqtt.js) ⭐ 22 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-17 - Node.js based interface between Homematic and MQTT.
* [ccu-mcp](https://github.com/claymore666/ccu-mcp) ⭐ 9 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-16 - MCP server enabling AI assistants to control Homematic devices via the CCU's JSON-RPC API, no addon required.
* [OpenCCU-Loom](https://github.com/SukramJ/openccu-loom) ⭐ 5 | 🐛 1 | 🌐 Go | 📅 2026-09-17 - Standalone Go daemon bridging Homematic / Homematic IP CCUs to MQTT (with Home Assistant Discovery), REST + WebSocket, an MCP server and a native Matter bridge.
* [matterbridge-homematic](https://github.com/hobbyquaker/matterbridge-homematic) ⭐ 4 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-16 - [Matterbridge](https://github.com/Luligu/matterbridge) ⭐ 974 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-19 Plugin to bridge a Homematic CCU's devices to the Matter ecosystem.
...
* [homematic-manager](https://github.com/hobbyquaker/homematic-manager) ⭐ 196 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-19 - Manage homematic interface processes (rfd/hs485d/homegear).
* [HMDeviceFirmware](https://github.com/OpenCCU/HMDeviceFirmware) ⭐ 34 | 🐛 0 | 🌐 Shell | 📅 2026-09-19 - Archive of current and past firmware update files for HomeMatic and Homematic IP devices.
...
* [pydevccu](https://github.com/SukramJ/pydevccu) ⭐ 9 | 🐛 0 | 🌐 Python | 📅 2026-09-16 - Virtual HomeMatic CCU XML-RPC and JSON-RPC server with fake devices for development and testing.
...
* [homematicip-rest-api](https://github.com/hahn-th/homematicip-rest-api) ⭐ 239 | 🐛 1 | 🌐 Python | 📅 2026-09-16 - Python wrapper for the homematicIP REST API (Cloud / Access Point Based).
* [aiohomematic](https://github.com/SukramJ/aiohomematic) ⭐ 168 | 🐛 0 | 🌐 Python | 📅 2026-09-18 - Python 3 interface to interact with Homematic devices via XML-RPC and JSON-RPC, successor of [pyhomematic](https://github.com/danielperna84/pyhomematic) ⚠️ Archived and base of homematicip\_local.
...
* [homematic-rega](https://github.com/hobbyquaker/homematic-rega) ⭐ 8 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-09 - Node.js Homematic CCU ReGaHSS Remote Script Interface.
...
* [homematic-gqls](https://github.com/martin-riedl/homematic-gqls) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2025-07-06 - A GraphQL service to query Homematic IP components based on [homematicip-rest-api](https://github.com/hahn-th/homematicip-rest-api) ⭐ 239 | 🐛 1 | 🌐 Python | 📅 2026-09-16.
...
* [Home Assistant](https://www.home-assistant.io/) - via [homematicip\_local](https://github.com/SukramJ/homematicip_local) ⭐ 594 | 🐛 0 | 🌐 Python | 📅 2026-09-12 (CCU/OpenCCU) oder [homematicip-hcu](https://github.com/Ediminator/homematicip-hcu) ⭐ 73 | 🐛 7 | 🌐 Python | 📅 2026-09-19 (HCU).
* [ioBroker](https://www.iobroker.net/?lang=de) - via [hm-rpc](https://github.com/ioBroker/ioBroker.hm-rpc) ⭐ 62 | 🐛 91 | 🌐 HTML | 📅 2026-09-19 (Interface-Prozesse) und [hm-rega](https://github.com/ioBroker/ioBroker.hm-rega) ⭐ 43 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-18 (ReGaHSS) Adapter, [hmip](https://github.com/iobroker-community-adapters/ioBroker.hmip) ⭐ 31 | 🐛 36 | 🌐 JavaScript | 📅 2026-09-19 für den Homematic IP Cloud Access Point.
* [SmartHomeNG](https://www.smarthomeng.de/) - via [Plugins](https://github.com/smarthomeNG/plugins) ⭐ 44 | 🐛 8 | 🌐 Python | 📅 2026-09-18.
